 ...
 *
 */
public class CalculElp implements Serializable {
	 ...
	 * serialisation ID.
	 */
	private static final long serialVersionUID = 7362286076820994548L;
	...
	/**
	 * Nombre d'inscrits à l'ELP
	 */
	private Integer nbInscrits;
	
	/**
	 * Echelle de notation ECTS de l'ELP
	 */
	...
	public String toString() {
		return "CalculVet [elp=" + elp + ", notes=" + notes + ", nbInscrits="
